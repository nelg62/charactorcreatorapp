...
export default function AvatarCustomizer() {
  ...
  const updateAvatar = () => {
    ...
    > = {
      accessories: setSelectedAccessories,
      face: setSelectedFace,
      facialHair: setSelectedFacialHair,
      head: setSelectedHead,
      background: setSelectedBackgroundType,
    };

    const choicesArray: Record<string, string[]> = {
    ...
    if (setters[activeAttribute]) {
      setters[activeAttribute](
        choicesArray[activeAttribute][
          {
            accessories: accessoryIndex,
            face: faceIndex,
            facialHair: facialHairIndex,
            head: headIndex,
            background: backgroundTypeIndex,
          }[activeAttribute] || 0
        ]
      );
    }
